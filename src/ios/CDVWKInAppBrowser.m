...
- (void)createViews
{
	...
	NSLog(@"%@", @"Inappbrowser added notification observers!");
	...
	[[NSNotificationCenter defaultCenter]
		addObserver:self
		   selector:@selector(onAppWillLeaveForeground:)
...
- (void) onAppWillEnterForeground:(NSNotification*)notification {
	[self.webView evaluateJavaScript:@"document.body.style.animationPlayState = 'running'; document.body.style.transition = '';" completionHandler:nil];
	self.webView.userInteractionEnabled = true;
}

- (void) onAppWillLeaveForeground:(NSNotification*)notification {
	[self.webView evaluateJavaScript:@"document.body.style.animationPlayState = 'paused'; document.body.style.transition = 'none';" completionHandler:nil];
